...
import { Header, HeaderAccess, HeaderCapableMessageAdapter, Incoming, MessageAdapter, Outgoing } from '@tsdi/common';
import * as coap from 'coap';


@Injectable()
export class CoapMessageAdapter extends MessageAdapter<Record<string, any>, coap.OutgoingMessage> implements HeaderCapableMessageAdapter {
