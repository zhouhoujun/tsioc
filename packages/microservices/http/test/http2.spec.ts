...
describe('http2 server, HttpClient', () => {
    ...
    function rawH2Get(path: string): Promise<{ status: number; headers: http2.IncomingHttpHeaders; body: string }> {
