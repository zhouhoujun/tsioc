...
class NatsHttpHybridModule { }

describe('Nats hybrid HTTP server and Nats client', () => {
    ...
    before(async () => {
        ctx = await Application.run(NatsHttpHybridModule);
    ...
    it('resolves clients', () => { expect(httpClient).toBeDefined(); expect(natsClient).toBeDefined(); });
