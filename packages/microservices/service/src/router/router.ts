 ...
 */
@Abstract()
export abstract class Router<T = RouteHanlder> implements RequestHandler<ReadableLike<Incoming>>, RequestInterceptor<ReadableLike<Incoming>, any, RequestContext> {
    /**
     * protocol
     */
     ...
     * @param context
     */
    abstract intercept(input: ReadableLike<Incoming>, next: RequestHandler<ReadableLike<Incoming>, any, RequestContext>, context: RequestContext): Observable<any>;
}
