...
describe('Amqp hybrid HTTP server and Amqp client', () => {
    ...
    before(async () => {
        ctx = await Application.run(AmqpHttpHybridModule);
    ...
    it('resolves clients', () => { expect(httpClient).toBeDefined(); expect(amqpClient).toBeDefined(); });
