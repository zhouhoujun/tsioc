...
import { UDP_SERV_INTERCEPTORS, UdpClient, UdpClientModule, UdpMicroServModule, UdpServer } from '../src';
...
@Module({
    ...
    imports: [
        ...
        UdpMicroServModule
        // UdpMicroServiceModule.withOption({
        //     serverOpts: {
        //         // timeout: 1000,
        //         // connectOpts: {
        //         //     port: 2000
