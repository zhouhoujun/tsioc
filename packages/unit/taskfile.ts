...
@Task({
    ...
    template: {
        activity: 'each',
        each: [
            { clean: ['../../dist/unit/lib'], dist: '../../dist/unit/lib', uglify: true, tsconfig: './tsconfig.json' },
            // { clean: ['../../dist/unit/fesm5'], dist: '../../dist/unit/fesm5', uglify: false, tsconfig: './tsconfig.es2017.json' },
