import { AnnotationMetadata, DecoratorOption, TypeDef } from '@tsdi/ioc';
/**
 ...
 */
export declare function createTestDecorator<T extends TestMetadata>(name: string, options?: TestDecorOption<T>): TestDecorator<T>;
/**
 * test case decorator
 *
 * @export
 ...
 * @interface TestCase
 */
export declare const Test: TestCase;
/**
 ...
 * @interface BeforeAll
 */
export declare const Before: BeforeAll;
/**
 ...
 * @interface AfterAll
 */
export declare const After: AfterAll;
/**
