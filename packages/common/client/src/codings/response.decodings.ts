...
// import { HEAD, ResponseEvent, ResponseJsonParseError, HeaderMappings, UrlRequest, Packet, ResponsePacket, isEvent } from '@tsdi/common';
// import { Codings, DecodeHandler } from '@tsdi/common/codings';
// import { TransportContext, MimeAdapter, ResponseEventFactory, StreamAdapter, XSSI_PREFIX, ev, isBuffer, toBuffer } from '@tsdi/common/transport';
...
//     resolve(res: ResponseEvent, context: TransportContext) {
//         return defer(async () => {
//             if(isEvent(res)) return res;
