import { HeaderMappings, HeadersLike } from '@tsdi/common';
/**
 ...
 * @publicApi
 */
export declare class HttpResponse<T = any> extends HttpResponseBase {
    /**
...
export declare function isHttpEvent(target: any): target is HttpEvent<any>;
