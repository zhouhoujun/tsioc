...
let HttpXhrBackend = class HttpXhrBackend {
    ...
    handle(req, context) {
        ...
        if (req.method === common_1.JSONP) {
            throw new ioc_1.Exception(`Attempted to construct Jsonp request without HttpClientJsonpModule installed.`);
        }
        ...
        return new rxjs_1.Observable((observer) => {
            ...
            req.headers.forEach((name, values) => xhr.setRequestHeader(name, (0, ioc_1.isArray)(values) ? values.join(',') : String(values)));
            ...
            const partialFromXhr = () => {
                ...
                const status = xhr.status === 1223 ? 204 /* HttpStatusCode.NoContent */ : xhr.status;
                const statusText = xhr.statusText ?? common_1.statusMessage[status] ?? 'OK';
                // Parse headers from XMLHttpRequest - this step is lazy.
                const headers = new common_1.HeaderMappings(xhr.getAllResponseHeaders());
            ...
            const onLoad = () => {
                ...
                if (status !== 204 /* HttpStatusCode.NoContent */) {
                    ...
                    body = (0, ioc_1.isUndefined)(xhr.response) ? xhr.responseText : xhr.response;
                }
                ...
                if (req.responseType === 'json' && (0, ioc_1.isString)(body)) {
...
exports.HttpXhrBackend = HttpXhrBackend = tslib_1.__decorate([
    (0, ioc_1.Injectable)(),
    tslib_1.__metadata("design:paramtypes", [handler_1.XhrFactory])
], HttpXhrBackend);
