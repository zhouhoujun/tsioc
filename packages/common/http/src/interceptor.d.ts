 ...
 */
export declare const HTTP_COMMON_INTERCEPTORS: import("@tsdi/ioc").InjectToken<HttpInterceptor[]>;
/**
 ...
 */
export declare class HttpInterceptingHandler extends RequestInterceptingHandler<HttpRequest<any>, HttpEvent<any>> implements HttpHandler {
