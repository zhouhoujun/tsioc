...
export class FetchBackend implements HttpBackend {
  ...
  private async doRequest(
    ...
    try {
      ...
      const fetchPromise = fetch(request.urlWithParams, { signal, ...init });
    ...
    const headers = new HeaderMappings(response.headers as any);
    ...
    if (response.body) {
      ...
      try {
        ...
        observer.error(
          new HttpErrorResponse({
            error,
            headers: new HeaderMappings(response.headers as any),
