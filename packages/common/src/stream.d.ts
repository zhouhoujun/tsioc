...
export type IPipeDestination<T = any, P = any> = IWritable | IPipeDestinationIterableFunction<T> | IPipeDestinationPromiseFunction<T, P>;
export interface IStream extends IEventEmitter {
    pipe<T extends IWritable>(destination: T, options?: {
...
export type Encodings = "ascii" | "utf8" | "utf-8" | "utf16le" | "utf-16le" | "ucs2" | "ucs-2" | "base64" | "base64url" | "latin1" | "binary" | "hex";
