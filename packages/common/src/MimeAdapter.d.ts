 ...
 * mime type adapter.
 */
export declare abstract class MimeAdapter {
    /**
     * mime types.
     */
    ...
    isJson(contentType: string): string | false;
    isXml(contentType: string): string | false;
    isText(contentType: string): string | false;
    isForm(contentType: string): string | false;
}
/**
 * split type
 */
 ...
 * mime db.
 */
export declare abstract class MimeDb {
...
export declare abstract class MimeTypes {
    /**
...
export declare abstract class AcceptsPriority {
