import { Token, lang, SymbolType, Type, InstanceFactory, IInjector, tokenId, IProvider, ProviderInjector, TypeReflectsToken, InjectorProxy, TokenId } from '@tsdi/ioc';
...
export class ModuleProviders extends ProviderInjector implements IProvider {
