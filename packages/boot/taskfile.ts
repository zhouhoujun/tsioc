...
@Task({
    ...
    template: {
        activity: 'each',
        each: [
            { clean: ['../../dist/boot/lib'], dist: '../../dist/boot/lib', uglify: true, tsconfig: './tsconfig.json' },
            // { clean: ['../../dist/boot/fesm2015'], dist: '../../dist/boot/fesm2015', uglify: true, tsconfig: './tsconfig.es2015.json' }
        ],
        body: [
            <TsBuildOption>{
                activity: 'ts',
