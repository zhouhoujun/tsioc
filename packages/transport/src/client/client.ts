...
//  */
// @Abstract()
// export abstract class TransportClient<TConnection extends EventEmitter = EventEmitter> extends Client implements OnDispose {

//     private _conn?: TransportClientOpts;
//     constructor(options: TransportClientOpts) {
//         super();
//     }
