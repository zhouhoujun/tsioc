...
import { Application, ApplicationContext, RunContext } from '../src';
...
export class ExceptionHandlers {
    ...
    catchMessing(exception: MissingParameterException, context: RunContext, ctx: ApplicationContext) {
    ...
    catchArgumentError(exception: ArgumentException, context: RunContext, ctx: ApplicationContext) {
