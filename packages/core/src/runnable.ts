...
export abstract class RunnableSet implements ScanSet<Runnable> {
     ...
     * get all.
     */
    abstract getAll(): OperationFactory<Runnable>[];
    /**
     ...
     * @param order order.
     */
    abstract add(resolver: OperationFactory<Runnable>, order?: number): void;
    /**
     * remove service resolver.
     * @param resolver remove the resolver.
     */
    abstract remove(resolver: OperationFactory<Runnable>): void;
    /**
