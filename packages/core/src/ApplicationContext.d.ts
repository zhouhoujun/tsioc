import { Provider, Injector, AbstractType, Type, Modules, ModuleOption, ModuleRef, ModuleMetadata, ModuleDef, ClassRef, Invocation, InvokeOptions, ModuleType } from '@tsdi/ioc';
 ...
 */
export declare abstract class ApplicationContext<T = object> extends Injector implements ApplicationEventPublisher {
    /**
     * 模块实例
     */
 ...
 */
export declare abstract class ApplicationContextFactory {
    /**
     * 创建应用程序上下文实例
     * @param root 主模块引用
     * @param option 应用程序选项
