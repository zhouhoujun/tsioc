    ...
    assets: {
        ...
        es2017: {
            sequence: [
                ...
                { src: 'lib/**/*.js', dest: 'es2017', data: { name: 'core.js', input: './lib/index.js' }, activity: CoreRollup }
            ]
        },
        ts2015: {
            sequence: [
                ...
                { src: 'lib/**/*.js', dest: 'es2015', data: { name: 'core.js', input: './lib/index.js' }, activity: CoreRollup }
            ]
        }
    }
})
