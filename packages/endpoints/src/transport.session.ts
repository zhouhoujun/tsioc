...
@Abstract()
export abstract class ServerTransportSession<TSocket = any, TMsg = any> extends TransportSession<TSocket, RequestContext, any, TMsg> {
...
export abstract class ServerTransportSessionFactory<TSocket = any, TMsg = any> {
     ...
     * @param options 
     */
    abstract create(injector: Injector, socket: TSocket, options: TransportOpts): ServerTransportSession<TSocket, TMsg>;
}
