...
export class UrlRequestContext<TRequest extends UrlIncoming<any> = UrlIncoming<any>, TResponse extends Outgoing<any> = Outgoing<any>, TSocket = any> extends RestfulRequestContext<TRequest, TResponse, TSocket> {
...
export class PatternRequestContext<TRequest extends Incoming<any> = Incoming<any>, TResponse extends Outgoing<any> = Outgoing<any>, TSocket = any> extends AbstractRequestContext<TRequest, TResponse, TSocket> {
...
export class TopicRequestContext<TRequest extends TopicIncoming<any> = TopicIncoming<any>, TResponse extends Outgoing<any> = Outgoing<any>, TSocket = any> extends AbstractRequestContext<TRequest, TResponse, TSocket> {
