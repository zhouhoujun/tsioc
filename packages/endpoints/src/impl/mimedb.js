...
exports.db = exports.BasicMimeDb = void 0;
const tslib_1 = require("tslib");
const ioc_1 = require("@tsdi/ioc");
const common_1 = require("@tsdi/common");
let BasicMimeDb = class BasicMimeDb extends common_1.MimeDb {
    constructor() {
        super();
        this.map = new Map();
        this.extenType = new Map();
        this.from(exports.db);
    }
    from(db) {
        this.map.clear();
...
exports.BasicMimeDb = BasicMimeDb;
exports.BasicMimeDb = BasicMimeDb = tslib_1.__decorate([
...
//# sourceMappingURL=mimedb.js.map