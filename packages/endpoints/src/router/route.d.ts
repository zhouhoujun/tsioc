import { Handler, HandlerFn, HandlerLike, Invocation, Token, AbstractType, TokenOf } from '@tsdi/ioc';
 ...
 * ROUTES
 */
export declare const ROUTES: import("@tsdi/ioc").InjectToken<Routes>;
/**
 * route options
 */
