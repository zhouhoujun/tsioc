 ...
 */
export declare function toDefine<T>(decor: DecoratorFn, metadata: T, decorType: DecoratorType, options: DecoratorOption<any>, propertyKey?: string, parameterIndex?: number): DecorDefine<T>;
/**
 * decorator funcation.
 */
 ...
 */
export type DecoratorScope = DecoratorType | 'beforeAnnoation' | 'afterAnnoation';
export declare const ctorName = "constructor";
export declare namespace Decors {
    const CLASS = "class";
    const property = "property";
    const method = "method";
    const parameter = "parameter";
    const beforeAnnoation = "beforeAnnoation";
    const afterAnnoation = "afterAnnoation";
}
