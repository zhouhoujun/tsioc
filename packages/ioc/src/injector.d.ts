...
export declare const RECORDS: unique symbol;
/**
 * injector.
 ...
 * IoC 容器，注入器
 */
export declare abstract class Injector implements Destroyable, OnDestroy {
    /**
     * 是否静态容器。
     */
...
export declare abstract class EnvironmentInjector extends Injector {
}
/**
 * ROOT injector instance token of self.
 */
export declare const INJECTOR: Token<Injector>;
/**
 * appliction platform injector token.
 */
export declare const CONTAINER: Token<Injector>;
/**
 ...
 */
export declare function isInjector(target: any): target is Injector;
/**
 * create platform injector.
 * @param providers
*/
export declare function createInjector(providers?: Provider[]): EnvironmentInjector;
/**
 * create injector.
 * @param parent
 * @param providers
 * @param scope
 */
export declare function createInjector(parent: Injector, providers?: Provider[], scope?: AbstractType | 'platform' | 'root' | 'static'): Injector;
/**
 * create injector with option.
 * @param options
 */
export declare function createInjector(parent: Injector, options?: InvokeProviders, scope?: AbstractType | 'static'): Injector;
/**
 * injector factory implement.
 */
export declare const INJECT_IMPL: {
