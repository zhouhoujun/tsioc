...
import { ParamProviders, ProviderMap, ProviderTypes } from './providers';
...
export class Container implements IContainer {
     ...
     * @memberof IContainer
     */
    getServices<T>(token: Token<T> | ((token: ClassType<T>) => boolean), target?: Token<any> | Token<any>[] | ParamProviders, both?: boolean| ParamProviders, resway?: ResoveWay | ParamProviders, ...providers: ParamProviders[]): T[] {
        let services: T[] = [];
