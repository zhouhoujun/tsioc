...
export abstract class TypeDecorators {
    constructor(protected type: ClassType, protected reflects: TypeReflects, protected register: DecoratorsRegisterer) {
    }
    ...
    get classDecors(): string[] {
        if (!this._clsDecors) {
            this._clsDecors =
                // this.reflects.getDecorators(this.type, false);
                this.register.getRegisterer(DecoratorScopes.Class)
                    .getDecorators()
    ...
    get propsDecors(): string[] {
        if (!this._prsDecors) {
            this._prsDecors =
                // this.reflects.getDecorators(this.type, 'property', false);
                this.register.getRegisterer(DecoratorScopes.Property)
                    .getDecorators()
    ...
    get methodDecors(): string[] {
        if (!this._mthDecors) {
            this._mthDecors =
                // this.reflects.getDecorators(this.type, 'method', false);
                this.register.getRegisterer(DecoratorScopes.Method)
                    .getDecorators()
