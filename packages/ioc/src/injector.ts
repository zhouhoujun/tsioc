...
import { InvocationContext, InvokeOption, OperationRef } from './invoker';
...
export abstract class Injector implements Destroyable, OnDestroy {
     ...
     *
     * @template T
     * @param {(T | OperationRef<T> | Type<T> | TypeReflect<T>)} target type of class or instance.
     ...
     */
    abstract invoke<T, TR = any>(target: T | OperationRef<T> | Type<T>, propertyKey: MethodType<T>, ...providers: ProviderType[]): TR;
    /**
     * invoke method.
     *
     * @template T
     ...
     * @returns {TR} the returnning of invoked method.
     */
    abstract invoke<T, TR = any>(target: T | OperationRef<T> | Type<T> | TypeReflect<T>, propertyKey: MethodType<T>, providers: ProviderType[]): TR;
    /**
     * invoke method.
     *
     * @template T
     ...
     * @returns {TR} the returnning of invoked method.
     */
    abstract invoke<T, TR = any>(target: T | OperationRef<T> | Type<T> | TypeReflect<T>, propertyKey: MethodType<T>, option?: InvokeOption): TR;
    /**
     * invoke method.
     *
     * @template T
     ...
     * @returns {TR} the returnning of invoked method.
     */
    abstract invoke<T, TR = any>(target: T | OperationRef<T> | Type<T> | TypeReflect<T>, propertyKey: MethodType<T>, context?: InvocationContext): TR;
    /**
     * get module loader.
     *
