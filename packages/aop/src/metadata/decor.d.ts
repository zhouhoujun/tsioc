import { AbstractType, AnnotationMetadata, DecoratorOption } from '@tsdi/ioc';
import { AdviceMetadata, AfterReturningMetadata, AfterThrowingMetadata, AspectMetadata, AroundMetadata, PointcutAnnotation } from './meta';
/**
 * Aspect decorator
 *
 * @export
...
export interface Aspect {
     ...
     * @param {(AbstractType | AbstractType[])>} [within]  set pointcut in the class with the annotation decorator only.
     * @param {AnnotationMetadata} [append] append class metadata.
     */
    (annotation: string, within?: AbstractType | AbstractType[], append?: AnnotationMetadata): ClassDecorator;
    /**
 ...
 * @Aspect()
 */
export declare const Aspect: Aspect;
/**
 ...
 * @NonePointcut()
 */
export declare const NonePointcut: NonePointcut;
/**
...
export declare function createAdviceDecorator<T extends AdviceMetadata>(adviceName: string, options?: DecoratorOption<T>): any;
/**
 * aop advice decorator.
 *
 * @Advice
 */
export declare const Advice: AdviceDecorator;
/**
 ...
 * @Pointcut
 */
export declare const Pointcut: Pointcut;
/**
 ...
 * @Before
 */
export declare const Before: IBeforeDecorator;
/**
 ...
 * @Around
 */
export declare const Around: Around;
/**
 ...
 * @AfterReturning
 */
export declare const AfterReturning: AfterReturning;
/**
 ...
 * @AfterThrowing
 */
export declare const AfterThrowing: AfterThrowing;
