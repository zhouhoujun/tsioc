 ...
 */
export declare class SequenceWorkflowTemplateBuilder {
    private template;
 ...
 * @returns 序列工作流模板 Sequence workflow template
 */
export declare function createSequenceTemplate(name: string, activities: ActivityTemplateConfig[], options?: Partial<SequenceWorkflowTemplate>): SequenceWorkflowTemplate;
