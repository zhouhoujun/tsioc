import { GCoreActivityConfigs, isAcitvityClass } from '@taskfr/core';
import { BuildConfigure, BuildHandleConfigure, TestConfigure, UglifyConfigure, WatchConfigure, CleanConfigure, AssetConfigure, DestConfigure, SourceConfigure, IAssetBuildHandle } from './core';
