...
export class UdpTransportSession extends TransportSession<Socket, UdpMessage> {
...
@Injectable()
export class UdpTransportSessionFactory implements TransportSessionFactory<Socket, TransportOpts> {

    constructor() { }

    create(injector: Injector, socket: Socket, options: TransportOpts): UdpTransportSession {
        return new UdpTransportSession(injector, socket,
