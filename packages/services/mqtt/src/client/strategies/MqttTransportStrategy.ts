...
@Injectable()
export class MqttTransportStrategy implements IClientTransportStrategy<any, any, any> {
    ...
    createRequest(pattern: Pattern, options: RequestInitOpts<any, any>): any {
        ...
        return { topic, payload: options.payload, qos: (options as any).qos ?? 1 };
    }

    initContext(context: any, request: any): void {
        context.mqttTopic = request.topic;
    }
...
export const MqttTransportStrategyToken = CLIENT_TRANSPORT_STRATEGY;