...
import { InternalServerException, HttpStatusCode, RequestMethod, getHeader } from '@tsdi/common';
import { Outgoing, append } from '@tsdi/common/transport';
...
interface Options {
     ...
     */
    origin?: string | ((ctx: RestfulRequestContext) => any);
    /**
