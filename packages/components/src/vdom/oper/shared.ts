 ...
 */
export function elementCreate(name: string, renderer: Renderer, namespace: string|null): RElement {
    ...
    if (directiveDefs !== null) {
      ...
      for (let i = 0; i < directiveDefs.length; i++) {
        ...
        if (!preOrderHooksFound &&
            (lifeCycleHooks.onChanges || lifeCycleHooks.onInit || lifeCycleHooks.onDoCheck)) {
        ...
        if (!preOrderCheckHooksFound && (lifeCycleHooks.onChanges || lifeCycleHooks.onDoCheck)) {
