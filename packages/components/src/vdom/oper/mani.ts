...
import { CONTAINER_HEADER_OFFSET, HAS_TRANSPLANTED_VIEWS, LContainer, MOVED_VIEWS, NATIVE } from '../container';
import { attachPatchData } from '../ctx_discovery';
import { ComponentDef, ViewEncapsulation } from '../definition';
import { TElementNode, TNode, TNodeFlags, TNodeType, TProjectionNode, TViewNode } from '../node';
...
export function createTextNode(value: string, renderer: Renderer): RText {
...
export function nativeInsertBefore(
    renderer: Renderer, parent: RElement, child: RNode, beforeNode: RNode | null): void {
