...
import { Runner, RunnableFactory, BootstrapOption, RunnableFactoryResolver, ApplicationContext } from '@tsdi/core';
 ...
 */
@Abstract()
export abstract class ComponentRef<C = any> extends Runner {
    /**
     * component type.
     */
