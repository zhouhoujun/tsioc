import { ClassRef, AbstractType, InvocationFactory, InvocationOptions, AbstractInvocation, TypeDef, ModuleType } from '@tsdi/ioc';
...
export declare const factoryKey = "\u01BFfac";
/**
 * 指令类型枚举
 */
 ...
 * DirectiveRef.
 */
export declare abstract class DirectiveRef<T> extends AbstractInvocation<T, DirectiveOptions, NodeInjector> {
    [noReact]: boolean;
    /**
 ...
 */
export declare abstract class DirectiveFactory<TOpts extends DirectiveOptions = DirectiveOptions> implements InvocationFactory<TOpts> {
    /**
