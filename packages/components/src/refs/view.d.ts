import { Destroyable, Type } from '@tsdi/ioc';
 ...
 * @publicApi
 */
export declare abstract class ViewRef<C = any> implements Destroyable {
    [noReact]: boolean;
    /**
 ...
 * @publicApi
 */
export declare abstract class EmbeddedViewRef<C> extends ViewRef<C> {
    /**
    ...
    /**
     * The injector context for this view.
     */
    abstract get injector(): NodeInjector;
    abstract get computedCache(): Map<string, {
        value: any;
        deps: Set<any>;
    }>;
