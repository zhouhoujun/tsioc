...
export enum TNodeType {
    /**
     * The TNode contains information about a DOM element aka {@link NText}.
     */
    Text = 0b1,

    /**
     * The TNode contains information about a DOM element aka {@link NElement}.
     */
    Element = 0b10,
    ...
    /**
     * The TNode contains information about an `<v-container>` element {@link NNode}.
     */
 ...
 */
export function toTNodeTypeAsString(nodeType: TNodeType): string {
    let text = '';
    (nodeType & TNodeType.Text) && (text += '|Text');
    (nodeType & TNodeType.Element) && (text += '|Element');
    (nodeType & TNodeType.Container) && (text += '|Container');
    (nodeType & TNodeType.ElementContainer) && (text += '|ElementContainer');
    (nodeType & TNodeType.Projection) && (text += '|Projection');
    (nodeType & TNodeType.Placeholder) && (text += '|Placeholder');
 ...
 */
export interface TElement<TNode, TParent, TChild, TView, TProjection> {
