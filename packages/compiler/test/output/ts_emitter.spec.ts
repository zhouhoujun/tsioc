...
import { TypeScriptEmitter } from '../..//src/output/ts_emitter';
import { ParseLocation, ParseSourceFile, ParseSourceSpan } from '../../src/util';
import { newArray } from '../../src/util';
import expect = require('expect');

import { stripSourceMapAndNewLine } from './emitter.spec';
import { extractSourceMap, originalPositionFor } from '../utils';
    ...
    describe('TypeScriptEmitter', () => {
        ...
        describe('emitter context', () => {
            it('should be able to back to the generating span', () => {
                ...
                expect(spanOf('someVar', returnLoc)).toEqual(referenceSpan); //, 'return span calculated incorrectly');
            });
        });
    });
