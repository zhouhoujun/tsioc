...
function newCharacterToken(index: number, end: number, code: number): Tokenize {
  return new Tokenize(index, end, TokenType.Character, code, String.fromCharCode(code));
}

function newIdentifierToken(index: number, end: number, text: string): Tokenize {
  return new Tokenize(index, end, TokenType.Identifier, 0, text);
}

function newKeywordToken(index: number, end: number, text: string): Tokenize {
  return new Tokenize(index, end, TokenType.Keyword, 0, text);
}

function newOperatorToken(index: number, end: number, text: string): Tokenize {
  return new Tokenize(index, end, TokenType.Operator, 0, text);
}

function newStringToken(index: number, end: number, text: string): Tokenize {
  return new Tokenize(index, end, TokenType.String, 0, text);
}

function newNumberToken(index: number, end: number, n: number): Tokenize {
  return new Tokenize(index, end, TokenType.Number, n, '');
}

function newErrorToken(index: number, end: number, message: string): Tokenize {
  return new Tokenize(index, end, TokenType.Error, 0, message);
}

export const EOF: Tokenize = new Tokenize(-1, -1, TokenType.Character, 0, '');
