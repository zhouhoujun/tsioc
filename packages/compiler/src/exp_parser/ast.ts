...
import { ParserError, ParseSourceSpan, SecurityContext } from '../util';
 ...
 *   | 2. of items         |   forEach    |  items  |  expression  |
 *   | 3. let x = y        |      x       |    y    |   variable   |
 *   | 4. index as i       |      i       |  index  |   variable   |
 *   | 5. trackBy: func    |forEachTrackBy|   func  |  expression  |
 *   | 6. *ngIf="cond"     |     if       |   cond  |  expression  |
 *   |---------------------|--------------|---------|--------------|
 *
