...
import { CompileDirectiveSummary, CompileProviderMetadata, CompileTokenMetadata } from './metadata';
import { ASTWithSource, BindingType, BoundElementProperty, ParsedEvent, ParsedEventType, ParsedVariable } from '../exp_parser/ast';
...
/**
 * A variable declaration on a <v-template> (e.g. `var-someName="someLocalName"`).
 */
...
/**
 * A `<v-template>` element included in an Angular template.
 */
...
/**
 * A directive property with a bound value (e.g. `*if="condition").
 */
