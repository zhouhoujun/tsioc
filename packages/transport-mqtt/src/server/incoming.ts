...
export class MqttIncoming extends Readable implements Incoming<MqttClient> {
    ...
    constructor(readonly session: TransportSession<MqttClient>, private packet: Packet<Buffer>) {
