import { Interceptor, Filter, Incoming, Outgoing, EndpointContext, EndpointOptions, TransportSessionOpts } from '@tsdi/core';
 ...
 */
export interface TcpMicroServiceOpts extends EndpointOptions<EndpointContext, Outgoing> {
