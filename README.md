...
* 1.3.10
    ...
    2. add [`ComponentLifecycle`](https://github.com/zhouhoujun/tsioc/blob/master/src/core/ComponentLifecycle.ts) lifecycle hooks for @Component decorator class to invoke auto. now only implement `beforeInit`, `onInit` hooks.
